  ...
  return (
    <div className="px-4 py-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        >
          <div className='flex   bg-gradient-to-r via-gray-400 opacity-70  '><img className="justify-center  rounded-lg  w-50  rotate-y-180 pt-3 ml-2" src="./src/assets/1749634840250.png" />
          <div className="  bg-clip-text w-full relative"> <h1 className='text-4xl md:text-5xl font-bold text-cyan-300 mt-25'>Nikesh Bawankar</h1>
